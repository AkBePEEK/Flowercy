...
class _AIFloristScreenState extends State<AIFloristScreen> with LanguageStateMixin {
  ...
  Future<void> _generate() async {
    ...
    try {
      ...
      if (query.isEmpty) {
        query = "Create a bouquet for ${_occasionController.text.isNotEmpty ? _occasionController.text : 'special occasion'}";
      ...
      await AIFloristService().recommendFromText(
        query,
        userId: userId,
        occasion: _occasionController.text.isNotEmpty ? _occasionController.text : null,
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
                ...
                child: ListView.separated(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    return ListTile(
                      ...
                      subtitle: Text('${(flower['price_per_stem'] as num).toInt()} ₸', style: const TextStyle(fontSize: 12)),
                      trailing: isSelected 
          ...
          _buildTextField(_occasionController, t('select_occasion')),
          ...
          const SizedBox(height: 8),
          _buildTextField(_moodController, t('select_mood')),
